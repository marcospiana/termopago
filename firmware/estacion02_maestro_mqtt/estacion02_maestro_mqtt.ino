// TermoPago - ESTACION 02 - MAESTRO (ESP32)  [MQTT push, SIN polling]
// =====================================================================
...
//
// Maneja DOS canales: aspiradora02 (canal 0) y soplado02 (canal 1).
...
bool mqttConectar() {
  String clientId = "termopago-estacion02";
